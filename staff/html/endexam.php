...
<div class="container mt-5">
    <div class="card mb-3">
        <div class="card-header">
            <h3 class="card-title">Upload Test Paper1 PDF</h3>
        </div>
        <div class="card-body">
    ...
    <div class="form-group">
        <label for="pdf">Select a TEST PAPER1 PDF file to upload:</label><br>
            ...
            <?php
                if(isset($_POST['submit'])){
                    ...
                    if (move_uploaded_file($pdfTempName, $uploadDir . $uploadFile)) {
                        ...
                        $sql = "INSERT INTO endexamtest (name, pdf) VALUES ('$pdfName', '$uploadFile')";
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">TEST PAPER1</h3>
        </div>
        <div class="card-body">
            <?php
                // Retrieve the details of the last uploaded PDF file from the database
                $conn = mysqli_connect("localhost", "root", "", "cms");
                $sql = "SELECT * FROM endexamtest ORDER BY id DESC LIMIT 1";
