...
<div class="container mt-5">
    <div class="card mb-3">
        <div class="card-header">
            <h3 class="card-title">Upload Visssion Misssion</h3>
        </div>
        <div class="card-body">
        <form action="Corsecurri.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="pdf">Select avismis PDF file to upload:</label><br>
                <input type="file" name="pdf" class="form-control-file" id="pdf">
            </div> 
            <button type="submit" name="submit" class="btn btn-primary">Display</button>
        </form>
            <?php
                if(isset($_POST['submit'])){
                    ...
                    if (move_uploaded_file($pdfTempName, $uploadDir . $uploadFile)) {
                        ...
                        $table = $semname.$_POST['subject'].'vismis';
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Vission Mission</h3>
        </div>
        <div class="card-body">
        <form action="Corsecurri.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
