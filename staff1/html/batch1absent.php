...
.form-container {
    ...
    <div class="btns">
        ...
        <button  class="bttn" style="margin-right:100px"><a href="batch1attend.php">ADD Attendance</a></button>
</div>
...
$table = $semname.$_POST['subject'].'bat1attend';
$sql4 = "SELECT * FROM $table ORDER BY id ASC";
