...
<div class="container mt-5">
    <div class="card mb-3">
        <div class="card-header">
            <h3 class="card-title">Upload Testpaper</h3>
        </div>
        <div class="card-body">
        <form action="Corsecurri.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="pdf">Select a Testpaper PDF file to upload:</label><br>
            ...
            <?php
                if(isset($_POST['submit'])){
                    ...
                    if (move_uploaded_file($pdfTempName, $uploadDir . $uploadFile)) {
                        ...
                        $table = $semname.$_POST['subject'].'testpaper';
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Testpaper</h3>
        </div>
        <div class="card-body">
        <form action="Corsecurri.php" method="post" enctype="multipart/form-data">
            <div class="form-group">
