...
<form action="bright-weak1.php" method="POST">
  <div class="container">
    <h2>Test1</h2>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    $sql_bright = "SELECT * FROM $table WHERE test1 >= $bright_student";
    $result_bright = mysqli_query($con, $sql_bright);

    // Query for weak students
    $sql_weak = "SELECT * FROM $table WHERE test1 <= $weak_student";
    ...
    while($row = mysqli_fetch_assoc($result_bright)) {
        echo "<tr><td style='padding: .75rem; vertical-align: top;font-weight:bold;color:black;'>".$row["rollno"]."</td><td style='padding: .75rem; vertical-align: top;font-weight:bold;color:black;'>".$row["test1"]."</td></tr>";
    }
